...
from app.src.pieces import Piece, Pawn, Knight, Bishop
...
def test_move_piece():
    ...
    test_board = parse_fen("rnbqkbnr/ppp1pppp/8/3p4/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 1")
    test_board.move_piece(4, 4 ,3 ,3 )
    assert(test_board.board[4][4] is  None)
    assert(isinstance(test_board.board[3][3], Pawn) and test_board.board[3][3].color == "white")

    test_board = parse_fen("rnbqkb1r/ppp1pppp/5n2/8/8/2N2N2/PPPP1PPP/R1BQKB1R b KQkq - 0 1")
    ...
    test_board = parse_fen("q3kb1r/1pp1pppp/2n1b3/8/2B3n1/2N2N2/1PPP1PPP/2BQK2R w Kk - 0 1")
